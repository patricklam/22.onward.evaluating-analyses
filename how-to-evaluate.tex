...
section, we outline possible ways to solicit judgment of and to evaluate
such tools.

Language evaluations (and in particular the ones we study here) are
quite different from tool evaluations---the language designers make
the design decisions upfront, and there is no language design analogy
to the filtering-and-selecting steps (akin to steps in Information
Retrieval) that we will discuss.
...
Returning to the context of program transformation tools, exploratory, or pilot, studies can be useful to establish that the
...
the workflow and justify why they made those decisions.
...
set of legal candidates to consider, and must select some of the
